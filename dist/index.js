(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SideMenu", [], factory);
	else if(typeof exports === 'object')
		exports["SideMenu"] = factory();
	else
		root["SideMenu"] = factory();
...
exports.default = {
	props: {
		...
		state: {
			...
			validator: function validator(value) {
				return ['open', 'closed'].indexOf(value) !== -1;
			}
		}
	},

	computed: {
		startingSlide: function startingSlide() {
			return this.side === 'left' ? 0 : 1;
		},
		closingSlide: function closingSlide() {
	...
	methods: {
		initSwiper: function initSwiper() {
			...
			var initialSlide = this.side === 'left' ? 1 : 0;
			var self = this;

			this.swiper = new _swiper2.default(this.$refs.swiper, {
	...
	watch: {
		state: function state(_state) {
			var swiper = this.swiper,
			    ...
			    closingSlide = this.closingSlide;
		...
		activeIndex: function activeIndex(i) {
...
var update = __webpack_require__(1)("eea19394", content, false, {});
...
// module
exports.push([module.i, "\n.side-menu {\n  pointer-events: none;\n  width: 330px;\n  height: 100vh;\n  position: absolute;\n  top: 0;\n  overflow: visible;\n}\n.side-menu.closed .click-outside-catcher {\n    pointer-events: none;\n}\n.side-menu.closed .main {\n    box-shadow: none !important;\n}\n.side-menu.left {\n    left: 0;\n}\n.side-menu.left .click-outside-catcher {\n      left: 0;\n}\n.side-menu.left .main {\n      box-shadow: 2px 0px 24px rgba(0, 0, 0, 0.08), 2px 0px 4px rgba(0, 0, 0, 0.06);\n}\n.side-menu.right {\n    right: 0;\n}\n.side-menu.right .click-outside-catcher {\n      right: 0;\n}\n.side-menu.right .main {\n      box-shadow: -2px 0px 24px rgba(0, 0, 0, 0.08), -2px 0px 4px rgba(0, 0, 0, 0.06);\n}\n.side-menu .swiper-slide:not(.empty) {\n    pointer-events: all;\n}\n.side-menu .swiper-slide:not(.empty) .click-outside-catcher {\n      opacity: 0;\n      height: 100vh;\n      width: 100vw;\n      position: absolute;\n      top: 0;\n      z-index: 1;\n}\n.side-menu .swiper-slide:not(.empty) .main {\n      height: 100%;\n      z-index: 2;\n      position: relative;\n      background: white;\n      transition: box-shadow 0.2s ease;\n}\n", ""]);
...
!function(e,t){ true?module.exports=t():"function"==typeof define&&define.amd?define("On",[],t):"object"==typeof exports?exports.On=t():e.On=t()}(window,function(){return function(e){var t={};function n(r){if(t[r])return t[r].exports;var o=t[r]={i:r,l:!1,exports:{}};return e[r].call(o.exports,o,o.exports,n),o.l=!0,o.exports}return n.m=e,n.c=t,n.d=function(e,t,r){n.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:r})},n.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},n.t=function(e,t){if(1&t&&(e=n(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var r=Object.create(null);if(n.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var o in e)n.d(r,o,function(t){return e[t]}.bind(null,o));return r},n.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.p="",n(n.s=0)}([function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});t.default=function(e){var t={},n=null,r=function(){var e=window;return{height:e.innerHeight,width:e.innerWidth}};return window.addEventListener("resize",function(){n&&window.clearTimeout(n),n=window.setTimeout(function(){var e=Object.keys(t),n=r();e.forEach(function(e){var r=t[e];"function"==typeof r&&r(n)})},200)}),{resize:function(e){var n=arguments.length>1&&void 0!==arguments[1]&&arguments[1],o=function(e){for(var t=Date.now();e[t];)t+=1;return t}(t);return t[o]=e,n&&e(r()),o},off:function(e){delete t[e]}}}(),e.exports=t.default}])});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("31b60866", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    ...
    {
      ref: "swiper",
      staticClass: "side-menu swiper-container",
      class: [_vm.state, _vm.side]
    },
    [
      _c("div", { staticClass: "swiper-wrapper" }, [
        _c(
          "div",
          {
            ...
            class: { empty: _vm.side === "right" }
          },
          [
            _vm.side === "left"
              ? _c("div", {
                  staticClass: "click-outside-catcher",
                  on: { click: _vm.close }
                })
              : _vm._e(),
            _vm.side === "left"
              ? _c(
                  "div",
                  { staticClass: "main" },
                  [_vm.side === "left" ? _vm._t("content") : _vm._e()],
                  2
                )
              : _vm._e()
          ]
          ...
          [
            ...
            _vm.side === "right"
              ? _c(
                  "div",
                  { staticClass: "main" },
                  [_vm.side === "right" ? _vm._t("content") : _vm._e()],
                  2
                )
              : _vm._e()
          ]
